...
- [Related behavior intentionally excluded from this feature and the reason it is unnecessary now]
- [Future capability that MUST NOT shape this implementation without a current requirement]
